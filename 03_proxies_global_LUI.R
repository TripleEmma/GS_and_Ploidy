...
# the dataset under processed is standardized across regions
...
overall_years_LUI <- map(c(2008:2020), filter_cond) %>% bind_rows()
...
all_LUI_sd <- map(c(2008:2020), sd_LUI) %>% bind_rows()
