...
LUI_cond <- function(end){
    ...
    ## not the standardized across regions, but within region
...
# at community level, the ending years could be different
...
output <- "results/06_manuscript/TableS2_F_test.txt"
